...
import com.alibaba.csp.sentinel.dashboard.datasource.config.DataSourceProperties;
import com.alibaba.csp.sentinel.dashboard.datasource.config.NacosDataSourceProperties;
 ...
 **/
@Configuration
@ConditionalOnProperty(name = "datasource.provider", havingValue = DataSourceProperties.NACOS_PROVIDER, matchIfMissing = true)
@EnableConfigurationProperties(NacosDataSourceProperties.class)
public class NacosConfiguration {

    @Autowired
    private NacosDataSourceProperties nacosProperties;
